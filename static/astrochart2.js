...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \*****************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_0__ =
						__webpack_require__(/*! ../utils/Utils.js */ './src/utils/Utils.js');
  ...
  \**********************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony import */ var _universe_Universe_js__WEBPACK_IMPORTED_MODULE_0__ =
						__webpack_require__(/*! ../universe/Universe.js */ './src/universe/Universe.js');
					/* harmony import */ var _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__ =
						__webpack_require__(/*! ../utils/SVGUtils.js */ './src/utils/SVGUtils.js');
					/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__ =
						__webpack_require__(/*! ../utils/Utils.js */ './src/utils/Utils.js');
					/* harmony import */ var _utils_AspectUtils_js__WEBPACK_IMPORTED_MODULE_3__ =
						__webpack_require__(/*! ../utils/AspectUtils.js */ './src/utils/AspectUtils.js');
					/* harmony import */ var _Chart_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
						/*! ./Chart.js */ './src/charts/Chart.js'
					);
					/* harmony import */ var _points_Point_js__WEBPACK_IMPORTED_MODULE_5__ =
						__webpack_require__(/*! ../points/Point.js */ './src/points/Point.js');
					/* harmony import */ var _settings_DefaultSettings_js__WEBPACK_IMPORTED_MODULE_6__ =
						__webpack_require__(
							/*! ../settings/DefaultSettings.js */ './src/settings/DefaultSettings.js'
						);
					...
					class RadixChart extends _Chart_js__WEBPACK_IMPORTED_MODULE_4__['default'] {
						...
						constructor(universe) {
							if (
								(!universe) instanceof _universe_Universe_js__WEBPACK_IMPORTED_MODULE_0__['default']
							) {
							...
							this.#root.setAttribute(
								'id',
								`${this.#settings.HTML_ELEMENT_ID}-${this.#settings.RADIX_ID}`
							);
						...
						getAscendantShift() {
							return (
								(this.#data?.cusps[0]?.angle ?? 0) +
								_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].DEG_180
							);
						}
						...
						getAspects(fromPoints, toPoints, aspects) {
							...
							toPoints = toPoints ?? [
								...this.#data.points,
								{ name: 'AS', angle: 0 },
								{ name: 'IC', angle: this.#data.cusps.at(3) },
								{ name: 'DS', angle: this.#data.cusps.at(6) },
								{ name: 'MC', angle: this.#data.cusps.at(9) }
							];
							aspects =
								aspects ??
								_settings_DefaultSettings_js__WEBPACK_IMPORTED_MODULE_6__['default']
									.DEFAULT_ASPECTS;

							return _utils_AspectUtils_js__WEBPACK_IMPORTED_MODULE_3__['default']
								.getAspects(fromPoints, toPoints, aspects)
						...
						drawAspects(fromPoints, toPoints, aspects) {
							...
							_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].cleanUp(
								aspectsWrapper.getAttribute('id'),
								this.#beforeCleanUpHook
							);
							...
							aspectsWrapper.appendChild(
								_utils_AspectUtils_js__WEBPACK_IMPORTED_MODULE_3__['default'].drawAspects(
									this.getCenterCircleRadius(),
						...
						#drawBackground() {
							...
							const mask =
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGMask(MASK_ID);
							const outerCircle = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].SVGCircle(this.#centerX, this.#centerY, this.getRadius());
							outerCircle.setAttribute('fill', 'white');
							mask.appendChild(outerCircle);

							const innerCircle = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].SVGCircle(this.#centerX, this.#centerY, this.getCenterCircleRadius());
							innerCircle.setAttribute('fill', 'black');
							mask.appendChild(innerCircle);
							wrapper.appendChild(mask);

							const circle = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGCircle(
								this.#centerX,
								this.#centerY,
								this.getRadius()
							);
							circle.setAttribute(
								'fill',
								this.#settings.CHART_STROKE_ONLY ? 'none' : this.#settings.CHART_BACKGROUND_COLOR
							);
							circle.setAttribute(
								'mask',
								this.#settings.CHART_STROKE_ONLY ? 'none' : `url(#${MASK_ID})`
							);
						...
						#drawAstrologicalSigns() {
							...
							const COLORS_SIGNS = [
								this.#settings.COLOR_ARIES,
								this.#settings.COLOR_TAURUS,
								this.#settings.COLOR_GEMINI,
								this.#settings.COLOR_CANCER,
								this.#settings.COLOR_LEO,
								this.#settings.COLOR_VIRGO,
								this.#settings.COLOR_LIBRA,
								this.#settings.COLOR_SCORPIO,
								this.#settings.COLOR_SAGITTARIUS,
								this.#settings.COLOR_CAPRICORN,
								this.#settings.COLOR_AQUARIUS,
								this.#settings.COLOR_PISCES
							];
							const SYMBOL_SIGNS = [
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_ARIES,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_TAURUS,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_GEMINI,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_CANCER,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_LEO,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_VIRGO,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_LIBRA,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_SCORPIO,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_SAGITTARIUS,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_CAPRICORN,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_AQUARIUS,
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SYMBOL_PISCES
							];

							const makeSymbol = (symbolIndex, angleInDegree) => {
								let position = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
									this.getOuterCircleRadius() -
										(this.getOuterCircleRadius() - this.getInnerCircleRadius()) / 2,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(
										angleInDegree + STEP / 2,
										this.getAscendantShift()
									)
								);

								let symbol = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGSymbol(
									SYMBOL_SIGNS[symbolIndex],
									position.x,
									position.y
								);
							...
							const makeSegment = (symbolIndex, angleFromInDegree, angleToInDegree) => {
								let a1 = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(
									angleFromInDegree,
									this.getAscendantShift()
								);
								let a2 = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(
									angleToInDegree,
									this.getAscendantShift()
								);
								let segment = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGSegment(
									this.#centerX,
									this.#centerY,
									this.getOuterCircleRadius(),
									a1,
									a2,
									this.getInnerCircleRadius()
								);
								segment.setAttribute(
									'fill',
									this.#settings.CHART_STROKE_ONLY ? 'none' : COLORS_SIGNS[symbolIndex]
								);
								segment.setAttribute(
									'stroke',
									this.#settings.CHART_STROKE_ONLY ? this.#settings.CIRCLE_COLOR : 'none'
								);
								segment.setAttribute(
									'stroke-width',
									this.#settings.CHART_STROKE_ONLY ? this.#settings.CHART_STROKE : 0
								);
								return segment;
							};
						...
						#drawRuler() {
							...
							for (let i = 0; i < NUMBER_OF_DIVIDERS; i++) {
								let startPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
									this.getRullerCircleRadius(),
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(startAngle)
								);
								let endPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
									i % 2
										? this.getInnerCircleRadius() -
												(this.getInnerCircleRadius() - this.getRullerCircleRadius()) / 2
										: this.getInnerCircleRadius(),
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(startAngle)
								);
								const line = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGLine(
									startPoint.x,
									startPoint.y,
									endPoint.x,
									endPoint.y
						...
						#drawPoints(data) {
							...
							const positions = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
								'default'
							].calculatePositionWithoutOverlapping(
								points,
								this.#settings.POINT_COLLISION_RADIUS,
								this.getPointCircleRadius()
							);
							for (const pointData of points) {
								const point = new _points_Point_js__WEBPACK_IMPORTED_MODULE_5__['default'](
									pointData,
									cusps,
									this.#settings
								);
								const pointPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
									this.getRullerCircleRadius() -
										(this.getInnerCircleRadius() - this.getRullerCircleRadius()) / 4,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(
										point.getAngle(),
										this.getAscendantShift()
									)
								);
								const symbolPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
									this.getPointCircleRadius(),
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(
										positions[point.getName()],
										this.getAscendantShift()
									)
								);

								// ruler mark
								const rulerLineEndPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
								...
								const rulerLine = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
									'default'
								].SVGLine(
									pointPosition.x,
									pointPosition.y,
									rulerLineEndPosition.x,
									rulerLineEndPosition.y
								);
								...
								const symbol = point.getSymbol(
									symbolPosition.x,
									symbolPosition.y,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].DEG_0,
								...
								const pointerLineEndPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
								...
								const pointerLine = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
									'default'
								].SVGLine(
									pointPosition.x,
									pointPosition.y,
									(pointPosition.x + pointerLineEndPosition.x) / 2,
									(pointPosition.y + pointerLineEndPosition.y) / 2
								);
						...
						#drawCusps(data) {
							...
							const textRadius =
								this.getCenterCircleRadius() +
								(this.getInnerCircleRadius() - this.getCenterCircleRadius()) / 10;

							for (let i = 0; i < cusps.length; i++) {
								const isLineInCollisionWithPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].isCollision(
									cusps[i].angle,
									pointsPositions,
									this.#settings.POINT_COLLISION_RADIUS / 2
								);

								const startPos = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
								...
								const endPos = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									...
									this.#centerX,
									this.#centerY,
									isLineInCollisionWithPoint
										? this.getCenterCircleRadius() +
												(this.getRullerCircleRadius() - this.getCenterCircleRadius()) / 6
										: this.getRullerCircleRadius(),
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(
										cusps[i].angle,
										this.getAscendantShift()
								...
								line.setAttribute(
									'stroke',
									mainAxisIndexes.includes(i)
										? this.#settings.CHART_MAIN_AXIS_COLOR
										: this.#settings.CHART_LINE_COLOR
								);
								line.setAttribute(
									'stroke-width',
									mainAxisIndexes.includes(i)
										? this.#settings.CHART_MAIN_STROKE
										: this.#settings.CHART_STROKE
								);
								wrapper.appendChild(line);
								...
								const gap =
									endCusp - startCusp > 0
										...
										: endCusp -
											startCusp +
											_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].DEG_360;
								const textAngle = startCusp + gap / 2;

								const textPos = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
								...
								const text = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGText(
									textPos.x,
									textPos.y,
									`${i + 1}`
								);
						...
						#drawMainAxisDescription(data) {
							...
							for (const axis of axisList) {
								...
								let endPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									...
									this.#centerX,
									this.#centerY,
									this.getRadius() + AXIS_LENGTH,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].degreeToRadian(
										axis.angle,
										this.getAscendantShift()
									)
								);
								let line = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGLine(
									startPoint.x,
									startPoint.y,
									endPoint.x,
									endPoint.y
								...
								let textPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
								...
								switch (axis.name) {
									case 'As':
										SHIFT_X -= STEP;
										SHIFT_Y -= STEP;
										symbol = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGSymbol(
											axis.name,
											textPoint.x + SHIFT_X,
											textPoint.y + SHIFT_Y
										);
						...
						#drawBorders() {
							...
							const outerCircle = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].SVGCircle(this.#centerX, this.#centerY, this.getOuterCircleRadius());
							...
							const innerCircle = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].SVGCircle(this.#centerX, this.#centerY, this.getInnerCircleRadius());
							...
							const centerCircle = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].SVGCircle(this.#centerX, this.#centerY, this.getCenterCircleRadius());
  ...
  \************************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony import */ var _charts_RadixChart_js__WEBPACK_IMPORTED_MODULE_0__ =
						__webpack_require__(/*! ../charts/RadixChart.js */ './src/charts/RadixChart.js');
					/* harmony import */ var _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__ =
						__webpack_require__(/*! ../utils/SVGUtils.js */ './src/utils/SVGUtils.js');
					/* harmony import */ var _Chart_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
						/*! ./Chart.js */ './src/charts/Chart.js'
					);
					/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__ =
						__webpack_require__(/*! ../utils/Utils.js */ './src/utils/Utils.js');
					/* harmony import */ var _utils_AspectUtils_js__WEBPACK_IMPORTED_MODULE_4__ =
						__webpack_require__(/*! ../utils/AspectUtils.js */ './src/utils/AspectUtils.js');
					/* harmony import */ var _points_Point_js__WEBPACK_IMPORTED_MODULE_5__ =
						__webpack_require__(/*! ../points/Point.js */ './src/points/Point.js');
					/* harmony import */ var _settings_DefaultSettings_js__WEBPACK_IMPORTED_MODULE_6__ =
					...
					class TransitChart extends _Chart_js__WEBPACK_IMPORTED_MODULE_2__['default'] {
						...
						constructor(radix) {
							if (
								!(radix instanceof _charts_RadixChart_js__WEBPACK_IMPORTED_MODULE_0__['default'])
							) {
							...
							this.#root.setAttribute(
								'id',
								`${this.#settings.HTML_ELEMENT_ID}-${this.#settings.TRANSIT_ID}`
							);
						...
						getAspects(fromPoints, toPoints, aspects) {
							...
							toPoints = toPoints ?? [
								...
								{ name: 'AS', angle: 0 },
								{ name: 'IC', angle: this.#radix.getData().cusps.at(3) },
								{ name: 'DS', angle: 180 },
								{ name: 'MC', angle: this.#radix.getData().cusps.at(9) }
							];
							aspects =
								aspects ??
								_settings_DefaultSettings_js__WEBPACK_IMPORTED_MODULE_6__['default']
							...
							return _utils_AspectUtils_js__WEBPACK_IMPORTED_MODULE_4__['default'].getAspects(
								fromPoints,
								toPoints,
								aspects
							);
						...
						drawAspects(fromPoints, toPoints, aspects) {
							...
							_utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__['default'].cleanUp(
								aspectsWrapper.getAttribute('id'),
								this.#beforeCleanUpHook
							);

							const aspectsList = this.getAspects(fromPoints, toPoints, aspects).filter(
								(aspect) => aspect.aspect.name != 'Conjunction'
							);

							aspectsWrapper.appendChild(
								_utils_AspectUtils_js__WEBPACK_IMPORTED_MODULE_4__['default'].drawAspects(
									this.#radix.getCenterCircleRadius(),
									this.#radix.getAscendantShift(),
									this.#settings,
									aspectsList
								)
							);
						...
						#drawRuler() {
							...
							for (let i = 0; i < NUMBER_OF_DIVIDERS; i++) {
								let startPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
									this.#getRullerCircleRadius(),
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__['default'].degreeToRadian(startAngle)
								);
								let endPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
									i % 2
										? this.getRadius() - (this.getRadius() - this.#getRullerCircleRadius()) / 2
										: this.getRadius(),
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__['default'].degreeToRadian(startAngle)
								);
								const line = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGLine(
						...
						#drawPoints(data) {
							...
							const positions = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
								'default'
							].calculatePositionWithoutOverlapping(
								points,
								this.#settings.POINT_COLLISION_RADIUS,
							...
							for (const pointData of points) {
								...
								const pointPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
									this.#getRullerCircleRadius() -
										(this.getRadius() - this.#getRullerCircleRadius()) / 4,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__['default'].degreeToRadian(
										point.getAngle(),
										this.#radix.getAscendantShift()
									)
								);
								const symbolPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
								...
								// ruler mark
								const rulerLineEndPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
								...
								const symbol = point.getSymbol(
									symbolPosition.x,
									symbolPosition.y,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__['default'].DEG_0,
									this.#settings.POINT_PROPERTIES_SHOW
								);
								symbol.setAttribute('font-family', this.#settings.CHART_FONT_FAMILY);
								symbol.setAttribute('text-anchor', 'middle'); // start, middle, end
								...
								// pointer
								//if (positions[point.getName()] != pointData.position) {
								const pointerLineEndPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerX,
						...
						#drawCusps(data) {
							...
							for (let i = 0; i < cusps.length; i++) {
								const isLineInCollisionWithPoint = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].isCollision(
									cusps[i].angle,
									pointsPositions,
								...
								const startPos = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
								...
								const endPos = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
								...
								const gap =
									endCusp - startCusp > 0
										...
										: endCusp -
											startCusp +
											_utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__['default'].DEG_360;
								const textAngle = startCusp + gap / 2;

								const textPos = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_3__[
									'default'
								].positionOnCircle(
									this.#centerX,
									this.#centerY,
  ...
  \*****************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony import */ var _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_0__ =
						__webpack_require__(/*! ../utils/SVGUtils.js */ './src/utils/SVGUtils.js');
					/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__ =
						__webpack_require__(/*! ../utils/Utils.js */ './src/utils/Utils.js');
					...
					class Point {
						...
						getSymbol(xPos, yPos, angleShift = 0, isProperties = true) {
							...
							const symbol = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_0__['default'].SVGSymbol(
								this.#name,
								xPos,
								yPos
							);
							...
							const angleFromSymbolToCenter = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].positionToAngle(xPos, yPos, chartCenterX, chartCenterY);
							...
							function angleInSign() {
								const angleInSignPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[
									'default'
								].positionOnCircle(
									xPos,
									yPos,
									2 * this.#settings.POINT_COLLISION_RADIUS,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__['default'].degreeToRadian(
										-angleFromSymbolToCenter,
										angleShift
									)
								);
								...
								this.#isRetrograde &&
									text.push(
										_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_0__['default']
											.SYMBOL_RETROGRADE_CODE
									);

								const angleInSignText = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_0__[
									'default'
								].SVGText(angleInSignPosition.x, angleInSignPosition.y, text.join(' '));
								...
								angleInSignText.setAttribute(
									'font-size',
									this.#settings.POINT_PROPERTIES_FONT_SIZE
								);
							 ...
							 */
							function dignities() {
								const dignitiesPosition = _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__[
									'default'
								].positionOnCircle(
									xPos,
									yPos,
									3 * this.#settings.POINT_COLLISION_RADIUS,
									_utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__['default'].degreeToRadian(
										-angleFromSymbolToCenter,
										angleShift
									)
								);
								const dignitiesText = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_0__[
									'default'
								].SVGText(dignitiesPosition.x, dignitiesPosition.y, this.getDignity());
								...
								dignitiesText.setAttribute(
									'font-size',
									this.#settings.POINT_PROPERTIES_FONT_SIZE / 1.2
								);
						...
						getSignNumber() {
							let angle =
								this.#angle % _utils_Utils_js__WEBPACK_IMPORTED_MODULE_1__['default'].DEG_360;
  ...
  \*****************************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony import */ var _constants_Universe_js__WEBPACK_IMPORTED_MODULE_0__ =
						__webpack_require__(
							/*! ./constants/Universe.js */ './src/settings/constants/Universe.js'
						);
					/* harmony import */ var _constants_Radix_js__WEBPACK_IMPORTED_MODULE_1__ =
						__webpack_require__(/*! ./constants/Radix.js */ './src/settings/constants/Radix.js');
					/* harmony import */ var _constants_Transit_js__WEBPACK_IMPORTED_MODULE_2__ =
						__webpack_require__(
							/*! ./constants/Transit.js */ './src/settings/constants/Transit.js'
						);
					/* harmony import */ var _constants_Point_js__WEBPACK_IMPORTED_MODULE_3__ =
						__webpack_require__(/*! ./constants/Point.js */ './src/settings/constants/Point.js');
					/* harmony import */ var _constants_Colors_js__WEBPACK_IMPORTED_MODULE_4__ =
						__webpack_require__(/*! ./constants/Colors.js */ './src/settings/constants/Colors.js');
					/* harmony import */ var _constants_Aspects_js__WEBPACK_IMPORTED_MODULE_5__ =
						__webpack_require__(
							/*! ./constants/Aspects.js */ './src/settings/constants/Aspects.js'
						);
					...
					const SETTINGS = Object.assign(
						...
						_constants_Transit_js__WEBPACK_IMPORTED_MODULE_2__,
						_constants_Point_js__WEBPACK_IMPORTED_MODULE_3__,
						_constants_Colors_js__WEBPACK_IMPORTED_MODULE_4__,
						_constants_Aspects_js__WEBPACK_IMPORTED_MODULE_5__
					);
  ...
  \*****************************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony export */ __webpack_require__.d(__webpack_exports__, {
						...
						/* harmony export */ POINT_PROPERTIES_FONT_SIZE: () =>
							/* binding */ POINT_PROPERTIES_FONT_SIZE,
  ...
  \*******************************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony export */ __webpack_require__.d(__webpack_exports__, {
						...
						/* harmony export */ TRANSIT_POINTS_FONT_SIZE: () =>
							/* binding */ TRANSIT_POINTS_FONT_SIZE
						/* harmony export */
					});
					/*
  ...
  \**********************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony import */ var _settings_DefaultSettings_js__WEBPACK_IMPORTED_MODULE_0__ =
						__webpack_require__(
							/*! ../settings/DefaultSettings.js */ './src/settings/DefaultSettings.js'
						);
					/* harmony import */ var _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__ =
					...
					/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__ =
						__webpack_require__(/*! ../utils/Utils.js */ './src/utils/Utils.js');
					/* harmony import */ var _charts_RadixChart_js__WEBPACK_IMPORTED_MODULE_3__ =
						__webpack_require__(/*! ../charts/RadixChart.js */ './src/charts/RadixChart.js');
					/* harmony import */ var _charts_TransitChart_js__WEBPACK_IMPORTED_MODULE_4__ =
						__webpack_require__(/*! ../charts/TransitChart.js */ './src/charts/TransitChart.js');
					...
					class Universe {
						...
						constructor(htmlElementID, options = {}) {
							...
							this.#settings = Object.assign(
								{},
								_settings_DefaultSettings_js__WEBPACK_IMPORTED_MODULE_0__['default'],
								options,
								{
									HTML_ELEMENT_ID: htmlElementID
								}
							);
							this.#SVGDocument = _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__[
								'default'
							].SVGDocument(
								this.#settings.CHART_VIEWBOX_WIDTH,
								this.#settings.CHART_VIEWBOX_HEIGHT
							);
							document.getElementById(htmlElementID).appendChild(this.#SVGDocument);

							// create wrapper for aspects
							this.#aspectsWrapper =
								_utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGGroup();
							this.#aspectsWrapper.setAttribute(
								'id',
								`${this.#settings.HTML_ELEMENT_ID}-${this.#settings.ASPECTS_ID}`
							);
							...
							this.#transit = new _charts_TransitChart_js__WEBPACK_IMPORTED_MODULE_4__['default'](
								this.#radix
							);
  ...
  \**********************************/
				/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					/* harmony import */ var _SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
						/*! ./SVGUtils.js */ './src/utils/SVGUtils.js'
					);
					...
					class AspectUtils {
						...
						static drawAspects(radius, ascendantShift, settings, aspectsList) {
							...
							for (const asp of aspectsList) {
								...
								const fromPoint = _Utils_js__WEBPACK_IMPORTED_MODULE_0__[
									'default'
								].positionOnCircle(
									centerX,
									centerY,
									radius,
									_Utils_js__WEBPACK_IMPORTED_MODULE_0__['default'].degreeToRadian(
										asp.from.angle,
										ascendantShift
									)
								);
								const toPoint = _Utils_js__WEBPACK_IMPORTED_MODULE_0__['default'].positionOnCircle(
									centerX,
									centerY,
									radius,
									_Utils_js__WEBPACK_IMPORTED_MODULE_0__['default'].degreeToRadian(
								...
								const symbol = _SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGSymbol(
									asp.aspect.name,
									lineCenterX,
									lineCenterY
								);
								...
								const line1 = _SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGLine(
									fromPoint.x,
									fromPoint.y,
									fromPointSpaceX,
									fromPointSpaceY
								...
								// line: center - toPoint
								const line2 = _SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'].SVGLine(
									toPointSpaceX,
									toPointSpaceY,
									toPoint.x,
									toPoint.y
						...
						static calculatePositionWithoutOverlapping(points, collisionRadius, circleRadius) {
							...
							const arrangePoints = () => {
								for (let i = 0, ln = _points.length; i < ln; i++) {
									const pointPosition = Utils.positionOnCircle(
										0,
										0,
										circleRadius,
										Utils.degreeToRadian(_points[i].angle)
									);
									...
									for (let j = 0; j < i; j++) {
										const distance = Math.sqrt(
											Math.pow(_points[i].x - _points[j].x, 2) +
  ...
  \**********************/
			__webpack_require__.r(__webpack_exports__);
			/* harmony export */ __webpack_require__.d(__webpack_exports__, {
				/* harmony export */ RadixChart: () =>
					/* reexport safe */ _charts_RadixChart_js__WEBPACK_IMPORTED_MODULE_3__['default'],
				/* harmony export */ SVGUtils: () =>
					/* reexport safe */ _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__['default'],
				/* harmony export */ TransitChart: () =>
					/* reexport safe */ _charts_TransitChart_js__WEBPACK_IMPORTED_MODULE_4__['default'],
				/* harmony export */ Universe: () =>
					/* reexport safe */ _universe_Universe_js__WEBPACK_IMPORTED_MODULE_0__['default'],
				/* harmony export */ Utils: () =>
					/* reexport safe */ _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__['default']
				/* harmony export */
			});
			/* harmony import */ var _universe_Universe_js__WEBPACK_IMPORTED_MODULE_0__ =
				__webpack_require__(/*! ./universe/Universe.js */ './src/universe/Universe.js');
			/* harmony import */ var _utils_SVGUtils_js__WEBPACK_IMPORTED_MODULE_1__ =
				__webpack_require__(/*! ./utils/SVGUtils.js */ './src/utils/SVGUtils.js');
			/* harmony import */ var _utils_Utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
				/*! ./utils/Utils.js */ './src/utils/Utils.js'
			);
			/* harmony import */ var _charts_RadixChart_js__WEBPACK_IMPORTED_MODULE_3__ =
				__webpack_require__(/*! ./charts/RadixChart.js */ './src/charts/RadixChart.js');
			/* harmony import */ var _charts_TransitChart_js__WEBPACK_IMPORTED_MODULE_4__ =
