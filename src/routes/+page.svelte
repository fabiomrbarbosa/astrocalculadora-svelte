...
<div class="grid h-full gap-4 lg:grid-cols-3">
	...
	>
		...
		<div role="alert" class="alert alert-warning alert-soft mt-4">
			...
			<span class="text-xs"
				>De momento, esta calculadora apenas aplica os <strong>padrões actuais</strong> de fusos horários
				e horários de Verão. Poderão ocorrer desvios, sobretudo em datas históricas.</span
			>
		</div>
	</form>
